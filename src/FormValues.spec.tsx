...
describe("FormValues", () => {
  it("sets and returns state", () => {
    const values = new FormValues<any>({}, createFormFields(), createFormFields())
  ...
  it("returns initial state", () => {
    const values = new FormValues({ foo: "bar" }, createFormFields(), createFormFields())

    expect(values.get()).toEqual({ foo: "bar" })
  })

  it("adds new state", () => {
    const values = new FormValues<any>({ foo: "bar" }, createFormFields(), createFormFields())
    values.add({ bar: "baz" })
  ...
  it("listens to changes", () => {
    const values = new FormValues({ foo: "bar", baz: { yolo: "swag" } }, createFormFields(), createFormFields())
